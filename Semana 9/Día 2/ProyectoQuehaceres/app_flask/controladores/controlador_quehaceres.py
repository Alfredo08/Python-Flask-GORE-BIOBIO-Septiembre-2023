...
@app.route('/quehaceres_usuarios', methods=['GET'])
def obtener_quehacers_con_usuarios():
    lista_quehaceres_usuarios = Quehacer.seleccionar_todos_con_usuarios()
    return render_template('quehaceres_usuarios.html', lista_quehaceres = lista_quehaceres_usuarios)
